    ...
    <>
      <section className="flex flex-col justify-center w-full bg-lightBlue rounded-tr-[120px] rounded-bl-[120px] relative">
        <header className='flex flex-col mt-5 items-start justify-center p-16 text-start'>
          ...
          <h3 className=" font-latoBold text-xl text-black whitespace-nowrap">Nuestros profesionales</h3>
        ...
        <section className="flex flex-wrap justify-center items-center gap-8 pb-16 md:px-16 lg:px-36  ">
          {
            medics.map(({ nombre, rol, img }) => {
              return (
                <div className="flex flex-col gap-5 p-4 pb-8 pt-4 rounded-3xl text-center bg-white shadow-2xl">
                  <img
                    src={img}
                    alt="Foto de médico"
                  ...
                  <div className='flex flex-col'>
                    <p className=' font-latoBold text-base text-black'>{nombre}</p>
        ...
        <img src={circulo} alt="detalle circular de la página" className="absolute w-[3rem] md:w-[4rem] left-0 -top-6" />
        <img src={circulo2} alt="detalle circular de la página" className="absolute w-[4rem] md:w-[6rem] right-0 -bottom-6" />
      </section>
    </>
  )
}
