...
const MenuHamburger = () => {
  ...
  return (
    <aside className="absolute w-16 md:w-20 h-1/2 left-0">
      ...
      <nav className={`w-full h-full text-white absolute transition-all duration-500 ease-in ${open ? "left-1" : "left-[-5rem]"} bg-[#3E36B0] rounded-3xl flex flex-col items-center gap-4`}>
